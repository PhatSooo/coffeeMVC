                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <input name="editProdDesc" value="<?php echo $rs['productDesc'] ?>" type="text" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2" placeholder="Input Product Description here....">
                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="products.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="productDesc" class="form-control" id="exampleTextarea1" rows="4"></textarea>
                        </div>
