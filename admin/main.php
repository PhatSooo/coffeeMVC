...
?>
  <div class="page-header">
    <h3 class="page-title"> All Orders You Recieved </h3>
  </div>
  ...
  <div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">Your Recieved Orders</h4>
          <div class="table-responsive">
            <table class="table">
              <thead>
                <tr>
              ...
              <tbody>
                <?php
                $total = 0;
                $get_list = $order->list_orderDetails();
                $i = 0;
                while ($row = $get_list->fetch_array()) {
                  if ($row['status'] == 3) {
                    $i++;
                ?>
                    <tr>
                      ...
                      <td><?= $total ?></td>
                      <td><a class="btn btn-info">Shipping</a></td>
                      <td><a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#viewDetails<?php echo $row['index'] ?>">View Details</a></td>
                    </tr>

                    <!-- Modal -->
                    <form action="cateedit.php" method="POST">
                      <div class="modal fade" id="viewDetails<?php echo $row['index'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              <a href="../classes/status.php?page=ship&status=complete&id=<?= $row['orderId'] ?>" type="submit" class="btn btn-success">Complete</a>
