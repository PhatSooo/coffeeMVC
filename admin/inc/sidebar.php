...
?>
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
            <a class="sidebar-brand brand-logo" href="main.php"><img src="assets/images/logo.svg" alt="logo" /></a>
            <a class="sidebar-brand brand-logo-mini" href="main.php"><img src="assets/images/logo-mini.svg" alt="logo" /></a>
        </div>
        <ul class="nav">
                ...
                <div class="profile-desc">
                    <div class="profile-pic">
                        ...
                        <div class="profile-name">
                            <h5 class="mb-0 font-weight-normal"><?= $_SESSION["adminName"] ?></h5>
                            <span><?= $_SESSION['adminUser'] ?></span>
                        </div>
                    </div>
        ...
        <ul class="nav">
            ...
            <li class="nav-item menu-items">
                <a class="nav-link" href="main.php">
                    ...
                    <span class="menu-title">Shipper Recieved</span>
                </a>
            </li>
            <li class="nav-item menu-items">
                <a class="nav-link" href="order_shipper.php">
                    <span class="menu-icon">
                        <i class="mdi mdi-speedometer"></i>
                    </span>
